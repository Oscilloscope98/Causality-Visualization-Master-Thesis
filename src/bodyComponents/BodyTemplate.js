                ...
                <svg id="Front-back-body" width={this.props.width} className='body-contents'
                    ...
                    <g id="F_Head">
                        ...
                        <path id="R_Eye_Discomfort" onClick={this.handleClick}
                            ...
                            transform="translate(-108.06 -42.73)" />
                        <path id="F_L_Ear_Discomfort_Or_Tinnitus" onClick={this.handleClick}
                            ...
                            transform="translate(-108.06 -42.73)" />
                        <path id="F_R_Ear_Discomfot_Or_Tinnitus" onClick={this.handleClick}
                    ...
                    <g id="B_Head">
                        ...
                        <path id="R_Back_Headache" onClick={this.handleClick}
                            ...
                            transform="translate(-108.06 -42.73)" />
                        <path id="B_L_Ear_Discomfort_Or_Tinnitus" onClick={this.handleClick}
                            ...
                            transform="translate(-108.06 -42.73)" />
                        <path id="B_R_Ear_Discomfort_Or_Tinnitus" onClick={this.handleClick}
                    ...
                    <g id="F_Shoulder">
                        ...
                        <path id="F_R_Shoulder_Discomfort" onClick={this.handleClick}
                            ...
                            transform="translate(-108.06 -42.73)" />
                        <ellipse id="F_L_Front_Axle_Discomfort_Or_Shoulder_Impingement" onClick={this.handleClick} cx="1123.39" cy="635.28"
                            rx="43.82" ry="53.86" transform="translate(-274.04 648.31) rotate(-31.96)" />
                        <ellipse id="F_R_Front_Axle_Discomfort_Or_Shoulder_Impingement" onClick={this.handleClick} cx="446.11" cy="632.28" rx="53.86"
                    ...
                    <g id="B_Shoulder">
                        ...
                        <path id="B_R_Shoulder_Discomfort" onClick={this.handleClick}
                            ...
                            transform="translate(-108.06 -42.73)" />
                        <ellipse id="B_L_Front_Axle_Discomfort_Or_Shoulder_Impingement" onClick={this.handleClick} cx="1815.9" cy="661.9" rx="53.86"
                            ry="43.82" transform="translate(184.98 1809.34) rotate(-58.04)" />
                        <ellipse id="B_R_Front_Axle_Discomfort_Or_Shoulder_Impingement" onClick={this.handleClick} cx="2484.48" cy="661.9" rx="43.82"
