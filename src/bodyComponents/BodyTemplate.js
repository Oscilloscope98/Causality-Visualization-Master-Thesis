                ...
                <svg width={this.props.width} className='body-contents front-back-body'
                    ...
                    <g id="Abdomen">
                        ...
                        <BodyPath pathId="Upper_Abdominal_Discomfort" onClick={this.handleClick} potentialSyms={this.props.potentialSyms} selectedSyms={this.props.selectedSyms}
                            ...
                            transform="translate(-108.06 -42.73)" />
                        <BodyPath pathId="L_Lower_Abdominal_Discomfort" onClick={this.handleClick} potentialSyms={this.props.potentialSyms} selectedSyms={this.props.selectedSyms}
                            ...
                            transform="translate(-108.06 -42.73)" />
                        <BodyPath pathId="R_Lower_Abdominal_Discomfort" onClick={this.handleClick} potentialSyms={this.props.potentialSyms} selectedSyms={this.props.selectedSyms}
                            ...
                            transform="translate(-108.06 -42.73)" />
                        <BodyPath pathId="IBS" onClick={this.handleClick} potentialSyms={this.props.potentialSyms} selectedSyms={this.props.selectedSyms}
