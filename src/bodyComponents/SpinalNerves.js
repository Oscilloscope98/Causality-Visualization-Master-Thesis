                ...
                <svg id="Spinal_Nerves" width={this.props.width} className='body-contents'
                    ...
                    <g id="Vertebrae">
                        ...
                        <SpinePath pathId="V_L2"
                            ...
                            transform="translate(-31.03 -18.52)" patterns={this.props.patterns} selectedCauses={this.props.selectedCauses} selectCause={this.props.selectCause} deleteCause={this.props.deleteCause}/>
                        <SpinePath pathId="V_L1"
                            d="M220.46,266.47c3.42-.47,3.42,3.81,2.85,6.67,1.71.71,6.46,0,6.46,3.33.19,4-4,.71-5.51.24-.95-.24-3-.24-3.23,1.18-.38,1.67,1.9,2.38,1.9,4.29,0,1.42-1.33,4.28-2.66,4.28-1.91.24-2.67-3.09-4-4-.19.72.32,3.81-.89,3.57l-.5-.08c-1.53.08-.64-2.77-.83-3.49-1.33,1-2.09,4.29-4,4-1.34,0-2.67-2.86-2.67-4.28,0-1.91,2.29-2.62,1.9-4.29-.18-1.42-2.28-1.42-3.23-1.18-1.52.47-5.7,3.8-5.51-.24,0-3.33,4.75-2.62,6.46-3.33-.57-2.86-.57-7.14,2.86-6.67Z"
                            transform="translate(-31.03 -18.52)" patterns={this.props.patterns} selectedCauses={this.props.selectedCauses} selectCause={this.props.selectCause} deleteCause={this.props.deleteCause}/>
                        <SpinePath pathId="V_T12"
                            d="M221.6,253.29c1,1.34,2.28.67,3.23,1.34,1.9.89.38,1.57-.19,2.91-.76,1.34.38,1.79.38,3.58,0,3.58-2.28.67-3.61,1.34s1,2.91.76,4.7c-.38,2.46-1.9,3.13-3.43,3.8-1.9.67-2.28,1.79-2.47,4,0,1.12.57,2.91-.76,3.43l-.57-.07c-1.27-.45-.89-2.24-.89-3.36-.19-2.24-.57-3.36-2.47-4-1.52-.67-3.05-1.34-3.43-3.8-.19-1.79,2.1-4,.76-4.7s-3.61,2.24-3.61-1.34c0-1.79,1.14-2.24.38-3.58-.57-1.34-2.09-2-.19-2.91.95-.67,2.28,0,3.23-1.34Z"
                            transform="translate(-31.03 -18.52)" patterns={this.props.patterns} selectedCauses={this.props.selectedCauses} selectCause={this.props.selectCause} deleteCause={this.props.deleteCause}/>
                        <SpinePath pathId="V_T11"
